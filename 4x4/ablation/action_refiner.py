    ...
    def refine(self, info: RLDecisionInfo) -> RefineResult:
        ...
        if self.decision_logger is not None:
            self.decision_logger.log({
                ...
                "safety_adjusted":   bool(result.safety_adjusted),
                "confidence_margin": float(info.confidence_margin),
                "action_scores":     [float(s) for s in info.action_scores],
                "anomaly_tags":      list(info.anomaly_tags),
