        ...
        for attempt in range(self.max_backoff_retries):
            ...
            try:
                ...
                if "429" in str(exc) or "rate_limit" in str(exc).lower():
                    # Fix: was linear (backoff_wait_s * (attempt+1)) which gave
                    # 60s, 120s, 180s... = up to 10min total for 5 retries.
                    # Now true exponential with a 120s cap:
                    # attempt 0->60s, 1->60s, 2->120s, 3->120s, 4->120s
